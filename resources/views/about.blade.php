...
<div class="container">
    <div class="row">
        <div class="col">
            <section>
                <h1 class="text-primary" id="about">About Us</h1>
                <p>
                    The Brown Sugar Factory Bahamas is an online store based in Nassau, The Bahamas. Our mission is to
                    provide quality simple luxury gifts and notions to improve a woman’s quality of life. Accessible
                    through our website 24/7 365 days a week we aim to be the #1 go to for gift giving whether for
                    yourself or the special lady in your life. With just a few clicks you can shop and have your items
            ...
            <hr>
            <section>
                <h1 id="terms" class="text-primary">Terms & Conditions</h1>

                <h3 class="text-primary">
                    Refund Policy
                </h3>
                <p>Always inspect your items on delivery or pick up as BSFB does not give refunds, accept returns or
                    exchanges unless the item you purchased is defective. If you receive a defective item on receipt
                    please contact us at WhatsApp 812-7156 on the same day of receipt with details of the product and
                    the defect and we will receive the defective product and replace product. Please note you will be
                    responsible for cost and means of getting the product to us. Matters will be handled in case by case
                    basis.

                    Delivery and handling fees are non refundable.
                </p>
                <p>

                    <h3 class="text-primary">Fulfillment of your order
                    </h3>

                    <h5 class="text-primary">Pick Up
                    </h5>
                    <p>
                        BSFB currently has a pick up location off of the Fox Hill round about. Pick up has to be
                        scheduled and must be in the time frame agreed upon. If you do not pick up in that agreed time
                        you will have to scheduled for another available time as we are not stationary at the location.
                        Contact WhatsApp 812-7156
                    </p>
                    <h5 class="text-primary">
                        Delivery
                    </h5>
                    <p>
                        Once you place an order delivery will be arranged. Delivery is normally on the same day in New
                        Providence. Depending on the time of day it may be on the next day. Name contact pinned location
                        or directions along with building color and or number must be provided a contact number you can
                        be reached on is vital in fulfilling all orders. BSFB will cancel your order if you cannot be
                        reached and/ or if directions are unclear. We may also cancel any reason if we may feel warrants
                        cancellation. No worries you will be notified if we have to.

                        Please let us know how much change is required upon confirmation of delivery so that the drivers
                        can provide you with quicker more efficient service.
                    ...
                    <p>
                        BSFB services all family islands. Once proof of deposit is communicated we normal ship on the
                        next available sail day. Allow 1-3 days for shipping and handling.
                        <span class="text-danger">*Fees May Apply</span>
            ...
            <hr>
            <section>
                <h1 class="text-primary" id="policy">Privacy Policy for The Brown Sugar Factory Bahamas</h1>

                <p>At Brown Sugar Factory Bahamas, accessible from brownsugarfactorybahamas.com, one of our main
                    priorities is the privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by Brown Sugar Factory Bahamas and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Brown Sugar Factory Bahamas. This
                ...
                <p>Brown Sugar Factory Bahamas follows a standard procedure of using log files. These files log visitors
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Brown
                    Sugar Factory Bahamas.</p>

                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Brown Sugar Factory Bahamas,
                ...
                <p>Note that Brown Sugar Factory Bahamas has no access to or control over these cookies that are used by
                    third-party advertisers.</p>

                <h2 class="text-primary">Third Party Privacy Policies</h2>

                <p>Brown Sugar Factory Bahamas's Privacy Policy does not apply to other advertisers or websites. Thus,
                    we are advising you to consult the respective Privacy Policies of these third-party ad servers for
                ...
                <p>Brown Sugar Factory Bahamas does not knowingly collect any Personal Identifiable Information from
